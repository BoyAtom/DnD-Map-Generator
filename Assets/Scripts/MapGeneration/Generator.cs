...
public abstract class Generator : MonoBehaviour {
	...
	void Start()
	{
        ...
        Sphere = transform.Find("Globe").GetComponent<MeshRenderer>();
	...
	protected virtual void Generate()
	{
        ...
        GenerateRivers ();
        Debug.Log("Generate rivers");
        BuildRiverGroups ();
        Debug.Log("Build river groups");
        DigRiverGroups ();
        Debug.Log("Dig river groups");
        AdjustMoistureMap ();
        Debug.Log("Adjust moisture map");

        UpdateBitmasks ();
        Debug.Log("Update bitmasks");
        FloodFill ();
        Debug.Log("Flood fill");

        GenerateBiomeMap ();
        Debug.Log("Generate biome map");
        UpdateBiomeBitmask();
        Debug.Log("Update biome bitmask");
        //Planet.GetComponent<MeshRenderer>().material.SetTexture("_PlanetTexture", BiomeMapRenderer.materials[0].mainTexture);
    }
	...
	protected void SetMaps()
	{
        ...
        Sphere.materials[0].mainTexture.filterMode = FilterMode.Point;
        Sphere.GetComponent<MeshRenderer>().materials[0].SetTexture("_BumpMap", normal);
        HeightMapRenderer.materials[0].mainTexture.filterMode = FilterMode.Point;
